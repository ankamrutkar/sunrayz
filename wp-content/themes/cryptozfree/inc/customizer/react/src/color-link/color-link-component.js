...
class ColorLinkComponent extends Component {
	constructor(props) {
		...
		let defaultParams = {
			colors: {
				'highlight': {
					tooltip: __( 'Initial', 'cryptozfree' ),
					palette: true,
				},
				'highlight-alt': {
					tooltip: __( 'Hover', 'cryptozfree' ),
					palette: true,
				},
				'highlight-alt2': {
					tooltip: __( 'Text Alt', 'cryptozfree' ),
					palette: true,
				},
			},
			styles: {
				'standard': {
					label: __( 'Standard (underline)', 'cryptozfree' ),
				},
				'color-underline': {
					label: __( 'Highlight Underline', 'cryptozfree' ),
				},
				'no-underline': {
					label: __( 'No Underline', 'cryptozfree' ),
				},
				'hover-background': {
					label: __( 'Background on Hover', 'cryptozfree' ),
				},
				'offset-background': {
					label: __( 'Offset Background', 'cryptozfree' ),
				},
			},
		};
	...
	render() {
		...
		return (
			<Fragment>
				<div className="cryptozfree-control-field cryptozfree-color-control cryptozfree-link-color-control">
					<span className="customize-control-title">
							{ __( 'Link Style', 'cryptozfree' ) }
					</span>
					<SelectControl
