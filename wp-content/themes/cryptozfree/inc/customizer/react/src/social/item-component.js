			...
			<div className="cryptozfree-sorter-item" data-id={ this.props.item.id } key={ this.props.item.id }>
				<div className="cryptozfree-sorter-item-panel-header">
					...
					<span className="cryptozfree-sorter-title">
						{ ( undefined !== this.props.item.label && '' !== this.props.item.label ? this.props.item.label : __( 'Social Item', 'cryptozfree' ) ) }
					</span>
				...
				{ this.state.open && (
					<div className="cryptozfree-sorter-item-panel-content">
						<TabPanel className="sortable-style-tabs cryptozfree-social-type"
												...
												<Fragment>
													...
													{ this.props.item.url && (
														<div className="social-custom-image">
															<div className="cryptozfree-social-image">
																<img className="cryptozfree-social-image-preview" src={ this.props.item.url } />
															</div>
															<Button
