...
class ContactComponent extends Component {
	constructor() {
		...
		let defaultParams = {
			...
			'options': [
				{ value: 'phone', label: __( 'Phone', 'cryptozfree' ), content: __( '444-546-8765', 'cryptozfree' ) },
				{ value: 'hours', label: __( 'Hours', 'cryptozfree' ), content: __( 'Mon - Fri: 8AM - 5PM', 'cryptozfree' ) },
				{ value: 'email', label: __( 'Email', 'cryptozfree' ), content: __( 'example@example.com', 'cryptozfree' ) },
				{ value: 'location', label: __( 'Address', 'cryptozfree' ), content: __( '4560 example street', 'cryptozfree' ) },
			],
		};
		...
		return (
			<div className="cryptozfree-control-field cryptozfree-sorter-items">
				...
				{ undefined !== availibleContactOptions[0] && undefined !== availibleContactOptions[0].value && (
					<div className="cryptozfree-contact-add-area cryptozfree-social-add-area">
						{ this.state.isVisible && (
							<Popover position="top right" className="cryptozfree-popover-color cryptozfree-popover-contact" onClose={ toggleClose }>
								<div className="cryptozfree-popover-contact-list cryptozfree-popover-social-list">
