...
class MeasureComponent extends Component {
	...
	render() {
		...
		return (
			<div className="cryptozfree-control-field cryptozfree-range-control">
				{ this.controlParams.responsive && (
					<ResponsiveControl
					...
					>
						...
						<div className="cryptozfree-units cryptozfree-locked">
							{ this.getResponsiveLockedButtons() }
						</div>
						{ this.controlParams.units && (
							<div className="cryptozfree-units">
				...
				{ ! this.controlParams.responsive && (
					<Fragment>
						...
						<div className="cryptozfree-responsive-controls-content">
							{ this.state.locked && (
								<RangeControl
								...
								<Fragment>
									<div className="measure-input-wrap">
										<input
											...
											className="measure-inputs"
										/>
										<small>{ __( 'Top', 'cryptozfree' ) }</small>
									</div>
									<div className="measure-input-wrap">
										<input
											...
											className="measure-inputs"
										/>
										<small>{ __( 'Right', 'cryptozfree' ) }</small>
									</div>
									<div className="measure-input-wrap">
										<input
											...
											className="measure-inputs"
										/>
										<small>{ __( 'Bottom', 'cryptozfree' ) }</small>
									</div>
									<div className="measure-input-wrap">
										<input
											...
											className="measure-inputs"
										/>
										<small>{ __( 'Left', 'cryptozfree' ) }</small>
									</div>
								</Fragment>
							) }
							<div className="cryptozfree-units cryptozfree-locked">
