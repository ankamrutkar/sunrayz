...
export const cryptozfreeColorPicker = ({ rgb, hex, hsv, hsl, onChange, renderers }) => {
  const styles = {
	picker: {
		width: 300,
		position: 'relative',
  ...
  return (
    <div style={ styles.picker } className={ 'cryptozfree-picker' }>
...
export default CustomPicker(cryptozfreeColorPicker)