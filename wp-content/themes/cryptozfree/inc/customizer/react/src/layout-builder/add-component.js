...
class AddComponent extends Component {
	...
	render() {
		...
		let classForAdd = 'cryptozfree-builder-add-item';
		...
		return (
			<div className={ classForAdd } key={ this.props.id }>
				{ this.state.isVisible && (
					<Popover position="top" className="cryptozfree-popover-add-builder" onClose={ toggleClose }>
						<div className="cryptozfree-popover-builder-list">
				...
				<Button
					className="cryptozfree-builder-item-add-icon"
					onClick={ () => {
