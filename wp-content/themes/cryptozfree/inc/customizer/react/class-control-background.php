...
/**
 * Class cryptozfree_Control_Background
 *
 * @access public
 */
class cryptozfree_Control_Background extends WP_Customize_Media_Control {
	/**
	 * Control type
	 *
	 * @var string
	 */
	public $type = 'cryptozfree_background_control';
...
$wp_customize->register_control_type( 'cryptozfree_Control_Background' );
